...
static void	draw_middle_bottom_half_triangle(t_env *env, t_point *top, t_point *middle, t_point *bottom)
{
	t_point	temp1;
	t_point	temp2;
	double	t;
...
static void	draw_top_middle_half_triangle(t_env *env, t_point *top, t_point *middle, t_point *bottom)
{
	t_point	temp1;
	t_point	temp2;
	double	t;
...
static void	sort(t_point *array)
{
	int		i;
	int		j;
	t_point	tmp;
...
static void	draw_triangle(t_env *env, t_point *a, t_point *b, t_point *c)
{
	t_point	p[3];
...
static void	ft_clear_buffer(t_env *env)
{
	int	x;
	int	y;
